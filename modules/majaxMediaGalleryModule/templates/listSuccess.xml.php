...
<rss version="2.0" xmlns:media="http://search.yahoo.com/mrss/">
  <channel>
    ...
    <item>
      ...
      <media:content url="<?php echo $media->photoToString(true, true); ?>" type="<?php echo $media->getPhotoMime(); ?>"
                     duration="5"/>
      <media:thumbnail url="<?php echo $media->photoToString(true, true); ?>"/>
      <?php endif; ?>
      <?php if ($media->getType() == 'Audio'): ?>
      <media:content url="<?php echo $media->audioToString(true); ?>" type="audio/mpeg"
                     duration="<?php echo $media->getLength(); ?>"/>
      <media:thumbnail url="<?php echo $media->photoToString(true); ?>"/>
      <?php endif; ?>
      <?php if ($media->getType() == 'Video'): ?>
      <media:content url="<?php echo $media->videoToString(true); ?>" type="video/x-flv"
                     duration="<?php echo $media->getLength(); ?>"/>
      <media:thumbnail url="<?php echo $media->photoToString(true, true); ?>"/>
      <?php endif; ?>
    </item>
