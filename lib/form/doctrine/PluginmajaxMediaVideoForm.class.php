 ...
 */
abstract class PluginmajaxMediaVideoForm extends BasemajaxMediaVideoForm
{
  public function setup()
  {
    ...
    $this->setWidget('video_file_id', new majaxMediaWidgetFormInputFile(array('file_id' => $this->getObject()->video_file_id)));
    $this->setValidator('video_file_id', new sfValidatorFile(
      array(
        'required' => false,
    ...
    $this->setValidator('video_file_delete', new sfValidatorPass());
